...
<div class="flex flex-col items-center gap-4">
	...
	<div class="relative">
		<!-- Highlight background - offset and positioned -->
		<div
			class="absolute left-1/4 top-1/2 z-0 h-12 w-full rounded-xl bg-brand-yellow dark:bg-brand-navy"
		></div>
	...
	<!-- Subtitle -->
	{#if subtitle}
		<p class="font-helvetica mt-4 text-sm text-muted-foreground">
			{subtitle}
		</p>
	{/if}
</div>
