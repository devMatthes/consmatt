  ...
  <div class="flex flex-col">
    <div class="flex flex-col gap-4 py-6">
      ...
      <a
        ...
        class="inline-flex items-center justify-end text-sm font-medium text-primary underline-offset-4 transition hover:underline"
      >
        <span class="font-medium">Sprawdź Szczegóły</span>
        <span class="ml-4 inline-flex h-4 w-4 shrink-0 rounded-full bg-brand-orange" aria-hidden="true"></span>
      </a>
    </div>
